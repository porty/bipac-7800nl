...
#define CC_FAP_MODULE
#endif

#define BCM_FAP_MOD_NAME "bcmfap"

#if defined(CC_FAP_MODULE)
/*
...
#endif //#if (defined(CONFIG_BCM96362) || defined(CHIP_6362)) && defined(CONFIG_BCM_FAP_MODULE)
...
#endif /* defined(CONFIG_MIPS_BRCM) */
#if defined(CONFIG_MIPS_BRCM) && defined(CC_FAP_MODULE)
        {
            /* This check is not needed for the FAP module */
            if ( strcmp(mod->name, BCM_FAP_MOD_NAME) != 0 )
#endif //defined(CONFIG_MIPS_BRCM) && defined(CC_FAP_MODULE)
		{
...
#endif	/* !defined(CONFIG_BALOO) && !defined(CONFIG_BRCM_BOUNCE) */
#endif  /* defined(CONFIG_MIPS_BRCM) */
	mutex_unlock(&module_mutex);
