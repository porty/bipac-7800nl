...
int vlanCtl_createVlanInterface(char *realDevName, unsigned int vlanDevId,
                                int isRouted, int isMulticast);
int vlanCtl_deleteVlanInterface(char *vlanDevName);
int vlanCtl_insertTagRule(char *realDevName, vlanCtl_direction_t tableDir, unsigned int nbrOfTags,
...
int vlanCtl_setDefaultAction(char *realDevName, vlanCtl_direction_t tableDir, unsigned int nbrOfTags,
                             vlanCtl_defaultAction_t defaultAction);
...
void vlanCtl_filterOnVlanDeviceMacAddr(void);
