...
#define BPA_MAX_GEMIDX          32  /**< Max number of GEM ports: 256?    */
...
{
    uint8_t  gemPortIdxQid[BPA_MAX_GEMIDX]; /**< Q on the dest GEM port. */
    uint32_t gemPortIdxMask[1]; /**< bitmap of GEM ports when GPON port bit
                                     is set in portMask                     */
 ...
 *
 * CAUTION: The filter e_ETH_FILT_ETHTYPE refers to Type field at offset 12 in 
