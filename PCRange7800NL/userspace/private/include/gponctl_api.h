...
int gponCtl_configGemPortQos(BCM_Ploam_CfgGemPortQosInfo *info);
...
int gponCtl_configGtcUs(BCM_Ploam_GtcUsCfgInfo *info);
 ...
 **********************************************/
int gponCtl_aeMode(BCM_AE_ModeInfo *info);
