...
#define OMCIPM_LOG_ERROR(fmt, arg...)                                     \
    printf(CLRwk "[ERROR " "%s" "] %-10s, %d: " fmt CLRnl, \
                                  OMCIPM_LOG_NAME, __FUNCTION__, __LINE__, ##arg);
...
typedef struct 
{
    ...
    OUT   UINT32 receivedFragments;    /*Compliant - Non-standard Counter*/
    OUT   UINT32 transmittedPackets;   /*Compliant - Non-standard Counter*/
    OUT   UINT32 transmittedBlocks;    /*Compliant*/
    OUT   UINT32 transmittedFragments; /*Compliant - Non-standard Counter*/
...
typedef struct 
{
    ...
    OUT   UINT32 hecCorrectedCodeWords;   /*Compliant - Non-standard Counter*/
    OUT   UINT32 hecUncorrectedCodeWords; /*Compliant - Non-standard Counter*/
