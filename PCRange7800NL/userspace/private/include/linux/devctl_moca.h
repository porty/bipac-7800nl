...
#define MoCA_DEF_USER_SNR_MARGIN_HIRF           3
 ...
 * application.
 */
#define MoCA_MAX_INIT_PARAMS				  33
#define MoCA_INIT_PARAM_ALL_MASK			  0x1FFFFFFFFLL
...
#define MoCA_INIT_PARAM_NW_SEARCH_FREQ_MASK           0x00000080LL
   UINT32         freqMask;
#define MoCA_INIT_PARAM_PASSWORD_SIZE_MASK            0x00000100LL
   UINT32         passwordSize;
#define MoCA_INIT_PARAM_PASSWORD_MASK                 0x00000200LL
   UINT8          password [MoCA_MAX_PASSWORD_LEN];
#define MoCA_INIT_PARAM_MCAST_MODE_MASK               0x00000400LL
   UINT32         mcastMode;
#define MoCA_INIT_PARAM_LAB_MODE_MASK                 0x00000800LL
   UINT32         labMode;
#define MoCA_INIT_PARAM_TABOO_START_CHAN_MASK         0x00001000LL
   UINT32         tabooStartChan;
#define MoCA_INIT_PARAM_TABOO_CHAN_MASK               0x00002000LL
   UINT32         tabooChanMask;
#define MoCA_INIT_PARAM_PAD_POWER_MASK                0x00004000LL
   signed int     padPower;
#define MoCA_INIT_PARAM_OPERATING_VERSION_MASK        0x00008000LL
   signed int     operatingVersion;
#define MoCA_INIT_PARAM_PREFERED_NC_MASK              0x00010000LL
   UINT32         preferedNC;
#define MoCA_INIT_PARAM_LED_MODE_MASK                 0x00020000LL
   UINT32         ledMode;
#define MoCA_INIT_PARAM_MAX_TX_POWER_PACKETS_MASK     0x00040000LL
   signed int     maxTxPowerPackets;
#define MoCA_INIT_PARAM_MoCA_LOOPBACK_EN_MASK         0x00080000LL
   UINT32         mocaLoopbackEn; 
#define MoCA_INIT_PARAM_BO_MODE_MASK                  0x00100000LL
   UINT32         boMode; 
#define MoCA_INIT_PARAM_RF_TYPE_MASK                  0x00200000LL
   UINT32         rfType; 
#define MoCA_INIT_PARAM_DEFAULT_CHANNEL_MASK          0x00400000LL
   UINT32         defaultChannel;
#define MoCA_INIT_PARAM_ASSIGNED_CHANNEL_MASK         0x00800000LL
   UINT32         assignedChannel;
#define MoCA_INIT_PARAM_MR_NON_DEF_SEQ_NUM_MASK       0x01000000LL
       UINT32     mrNonDefSeqNum; 
#define MoCA_INIT_PARAM_LOW_PRI_Q_NUM_MASK            0x02000000LL
   UINT32         lowPriQNum;
#define MoCA_INIT_PARAM_EGR_MC_FILTER_EN_MASK         0x04000000LL
      UINT32      egrMcFilterEn;
#define MoCA_INIT_PARAM_RESERVED_INIT_1_MASK          0x08000000LL
   UINT32         reservedInit1; 
#define MoCA_INIT_PARAM_RESERVED_INIT_2_MASK          0x10000000LL
   UINT32         reservedInit2; 
#define MoCA_INIT_PARAM_RESERVED_INIT_3_MASK          0x20000000LL
   UINT32         reservedInit3; 
#define MoCA_INIT_PARAM_RESERVED_INIT_4_MASK          0x40000000LL
   UINT32         reservedInit4; 
#define MoCA_INIT_PARAM_RESERVED_INIT_5_MASK          0x80000000LL
   UINT32         reservedInit5;
#define MoCA_INIT_PARAM_OPTIONS_MASK                  0x100000000LL
...
#define MoCA_CFG_PARAM_ALL_MASK                 0x7FFFFFFFFELL
#define MoCA_CFG_NON_LAB_PARAM_ALL_MASK         0x1FFBFFFEELL /* Due to issue with OutOfOrderLmo and
                                                                 core trace control */
#define MoCA_CFG_DEF_PARAM_MASK                 0x1FFFFEF0ELL  /* Parameters for which the defaults exist */
...
#define MoCA_CFG_PARAM_RX_POWER_TUNING_MASK          0x100000000LL
      UINT32               rxPowerTuning;
...
#define MoCA_CFG_PARAM_LAB_PILOTS_MASK               0x200000000LL
   UINT8             pilots [8];
#define MoCA_CFG_PARAM_IQ_DIAGRAM_SET_MASK           0x400000000LL
   MoCAIqDiagramSet  iq;
#define MoCA_CFG_PARAM_SNR_GRAPH_SET_MASK            0x800000000LL
   UINT32            MoCASnrGraphSetNodeId;
#define MoCA_CFG_PARAM_LAB_REG_MEM_MASK              0x1000000000LL
   MoCALabRegMem     RegMem;
#define MoCA_CFG_PARAM_LAB_CALL_FUNC_MASK            0x2000000000LL
   MoCALabCallFunc   callFunc;
#define MoCA_CFG_PARAM_LAB_TPCAP_MASK                0x4000000000LL
...
CmsRet MoCACtl2_RestoreDefaults();
