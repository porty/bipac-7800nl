 ...
 * @return CmsRet enum.
 */
CmsRet devCtl_adslInitialize(ADSL_FN_NOTIFY_CB pFnNotifyCb, UINT32 ulParm, adslCfgProfile *pAdslCfg);
CmsRet xdslCtl_Initialize(UINT8 lineId, ADSL_FN_NOTIFY_CB pFnNotifyCb, UINT32 ulParm, adslCfgProfile *pAdslCfg);
 ...
 * @return CmsRet enum.
 */
CmsRet devCtl_adslStartBERT(unsigned long totalBits);
CmsRet xdslCtl_StartBERT(unsigned char lineId, unsigned long totalBits);
 ...
 * @return CmsRet enum.
 */
CmsRet devCtl_adslBertStartEx(unsigned long bertSec);
CmsRet xdslCtl_BertStartEx(unsigned char lineId, unsigned long bertSec);
