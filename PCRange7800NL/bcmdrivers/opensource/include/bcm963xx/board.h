...
#define BOARD_IOCTL_SET_PROID           _IOWR(BOARD_IOCTL_MAGIC, 32, BOARD_IOCTL_PARMS)//simon 2010.02
#define BOARD_IOCTL_GET_PROID           _IOWR(BOARD_IOCTL_MAGIC, 33, BOARD_IOCTL_PARMS)//simon 2010.02
#define BOARD_IOCTL_SET_VENDORID        _IOWR(BOARD_IOCTL_MAGIC, 34, BOARD_IOCTL_PARMS)//simon 2010.02
#define BOARD_IOCTL_GET_VENDORID        _IOWR(BOARD_IOCTL_MAGIC, 35, BOARD_IOCTL_PARMS)//simon 2010.02
