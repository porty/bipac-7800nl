...
typedef enum BcmXtmStatus
{
    ...
    XTMSTS_TIMEOUT,
    /*howard add on 20090114*/
    XTMSTS_AUTOSCAN_ERROR
    /*howard end*/
} BCMXTM_STATUS;
...
typedef struct XtmConnCfg
{
    ...
    /*howard add on 20100112*/
    UINT32 uPvcAutoScan; // uPvcAutoScan = 1: It is autoscaning pvc. 
    UINT32 uInterfaceAlreadyExist;
    /*howard end*/	
...
#define PPPOE_2684_LLC          0
#define PPPOE_2684_VC           1
#define PPPOA_LLC               2
#define PPPOA_VC                3
#define DHCPCCLIENT_2684_LLC    4
#define DHCPCCLIENT_2684_VC     5
#define PACKET_TYPE_MAX      6

#define AUTOSCAN_LOOPBACK_DEFAULT_REPETITION     1
#define AUTOSCAN_LOOPBACK_DEFAULT_TIMEOUT        200    /* msec */
#define AUTOSCAN_LOOPBACK_RX_TIMEOUT_INTERVAL    10

typedef struct
{
    XTM_ADDR ConnAddr;
    UINT32 PotocolType[PACKET_TYPE_MAX];
    BCMXTM_STATUS bxStatus;
    UINT32 repetition;
    UINT32 start;
}XTMCFGDRV_AUTOSCAN_PVC, *PXTMCFGDRV_AUTOSCAN_PVC;
/*howard end*/
...
/*howard add on 20100114*/
BCMXTM_STATUS BcmXtm_AutoScanTest(PXTMCFGDRV_AUTOSCAN_PVC pKArg);
/*howard end*/
