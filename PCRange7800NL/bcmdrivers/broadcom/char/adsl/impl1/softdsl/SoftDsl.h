 ...
 * $Revision: 1.453 $
 *
 * $Id: SoftDsl.h,v 1.453 2009/02/10 14:38:44 ovandewi Exp $
 *
 * $Log: SoftDsl.h,v $
...
#if defined(G993) || defined(BCM6368_SRC)
...
#define	kDslPwrStateRequest                         213
...
typedef struct
	{
        ...
        uchar                           halfRoundtripAtucXmt, halfRoundtripAtucRcv;
#ifdef BCM6368_SRC
...
typedef struct
    ...
    uchar                           snrClampingId;
#endif
	uchar							dsMaxPcb, coFeature, coSWVersion[3],dsParCtrl, chipsetVersion;
...
extern void		SoftDslSetInteropBit(void *gDslVars, long bit);
extern void		SoftDslClearInteropBit(void *gDslVars, long bit);
extern int		SoftDslIsInteropBitSet(void *gDslVars, long bit);
...
#if !defined(WINNT) && !defined(__KERNEL__) && !defined(_CFE_)
...
#define	DSL_STATUS_CODE(x)	((x) & (~DSL_LINE_MASK))
