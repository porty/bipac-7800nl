...
#if defined(CONFIG_BCM96368) || defined(CHIP_6368) || defined(CONFIG_BCM96362) || \
      defined(CHIP_6362) || defined(CONFIG_BCM96328) ||defined(CHIP_6328)
#define MAX_LP_NUM 2
#else 
#define MAX_LP_NUM 1
#endif
...
typedef struct dslNtrCfg {
   ...
   ulong   updatePeriod;        /* PLL update period in ms */
