...
/*CPHYSADDR returns the physical address of a CKSEGx / XKPHYS address*/
#define CPHYSADDR(val1) sizeof(val1)
#define KSEG0ADDR(a)    ((((unsigned long)(a) & 0x1fffffff)))
#define KSEG1ADDR(a)    ((((unsigned long)(a) & 0x1fffffff)))
